    ...
    <div class="container mt-3">
        ...
        <form action="{{ route('orders.update', $order->id) }}" method="POST">
            ...
            <div class="form-group row">
                <label for="client_id" class="col-sm-2 col-form-label text-end text-right">ID klienta:</label>
                <div class="col-sm-10">
                    <input type="text" name="client_id" id="client_id" value="{{ $order->client_id }}" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label text-end text-right">Imię:</label>
                <div class="col-sm-10">
